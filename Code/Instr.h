...
namespace code {
	...
	Instr *STORM_FN begin(EnginePtr e, Block part);
	Instr *STORM_FN end(EnginePtr e, Block part);

	// Activate destruction of a particular variable. If jumping past one of these instructions,
	// make sure to execute another 'activate', 'begin' or 'end' instruction relatively soon, as
	// some backends rely on the code generated by this instruction to keep metadata updated.
