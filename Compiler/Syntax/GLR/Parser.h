	...
	namespace syntax {
		namespace glr {
			...
			private:
				...
				Node *tree(TreeNode *node, Nat startPos) const;

				// Fill in 'result' from the subtree generated by a pseudo-production.
				void subtree(Node *result, TreeNode *node, Nat startPos) const;

				// Fill in a token.
				inline void setToken(Node *result, TreeNode *node, Nat startPos, Token *token) const;
