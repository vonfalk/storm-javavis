...
* Loose ends so far [23/47]
  - [ ] Support documentation of templates from C++.
  - [ ] BSFunction and BSCtor should release their syntax tree after they are compiled.
  - [ ] The scope of parameters in Basic Storm is wrong (with respect to visibility).
