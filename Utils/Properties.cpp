...
namespace util {
	...
	void Properties::setOnUpdate(const Function<void> &fn) {
	...
	void Properties::load(util::Stream &from, Property *p) {
	...
	void Properties::save(util::Stream &to, const Property &p) {
	...
	void Properties::save(util::Stream &to) const {
	...
	void Properties::load(util::Stream &from) {
