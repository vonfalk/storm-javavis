...
namespace storm {
	...
	const BuiltInFunction *builtInFunctions() {
		static BuiltInFunction fns[] = {
			...
			{ Name(L"lang.bs"), L"Includes", Name(), L"add", list(1, Name(L"lang.bs.Pkg")), address<void(CODECALL storm::bs::Includes::*)(storm::bs::Pkg *)>(&storm::bs::Includes::add) },
			{ Name(L"lang.bs"), L"Pkg", Name(L"lang.bs.Pkg"), L"__ctor", list(1, Name(L"core.Type")), address(&create1<storm::bs::Pkg>) },
			{ Name(L"lang.bs"), L"Pkg", Name(), L"add", list(1, Name(L"core.Str")), address<void(CODECALL storm::bs::Pkg::*)(storm::Str *)>(&storm::bs::Pkg::add) },
